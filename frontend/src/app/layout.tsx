          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14">
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full font-medium">Sprint 6</span>
              </Link>
              <div className="flex items-center gap-6 text-sm font-medium">
                ...
                <Link href="/applications" className="text-gray-600 hover:text-blue-700 transition-colors">
                  Candidatures
                </Link>
        ...
        <footer className="border-t border-gray-200 mt-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <p className="text-xs text-gray-400 text-center">
              Agent Personnel de Recherche de Stage — Sprint 6 — Pipeline de candidatures
            </p>
          </div>
        </footer>
      </body>
